...
def export_to_coreml(model_name) :
    ...
    tfcoreml.convert(mlmodel_path = 'frozen/' + model_name + '.mlmodel', 
        ...
        output_feature_names = ['output/strided_slice_4:0','output/strided_slice_3:0'], 
...
def coreml_predict(model_name) :
    ...
    core_model = coremltools.models.MLModel('frozen/' + model_name + '_fp16.mlmodel')
    ...
    pixel_scores = results['output__strided_slice_3__0']
